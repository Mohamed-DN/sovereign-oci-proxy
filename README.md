...
[Key Features](#-key-features) • [Architecture Graphics](#-architecture-diagrams) • [5-Minute Quickstart](#-5-minute-quickstart) • [CLI Reference](#-operator-cli-reference) • [Multi-Cloud & K8s](#-multi-cloud--kubernetes-deployment) • [Auto-Scaling](#-dual-tier-auto-scaling) • [Documentation & Roadmap](#-documentation-index)
...
NeroNet v4.0 is released under the open-source **MIT License**. Maintained by the Sovereign Mesh Working Group.
